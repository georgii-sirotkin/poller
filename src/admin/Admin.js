        ...
        <div className="container-fluid">
          <div className="row">
              ...
              <div className="sidebar-sticky">
                <ul className="nav flex-column">
                  <li className="nav-item">
                    <NavLink exact to={`${this.props.match.url}/polls`} className="nav-link">
                  ...
                  <li className="nav-item">
                    <NavLink to={`${this.props.match.url}/polls/create`} className="nav-link">
            ...
            <main role="main" className="col-md-9 ml-sm-auto col-lg-10 px-4">
              <Switch>
                <Route path={`${this.props.match.path}/polls/create`}>
                  <AddPoll />
                </Route>
