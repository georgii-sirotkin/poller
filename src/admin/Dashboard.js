  ...
  return (
    <>
      <nav className="navbar navbar-dark fixed-top bg-dark flex-md-nowrap p-0 shadow">
        <Link to={match.url} className="navbar-brand col-sm-3 col-md-2 mr-0">Dashboard</Link>
      ...
      <div className="container-fluid">
        <div className="row">
            ...
            <div className="sidebar-sticky">
              <ul className="nav flex-column">
                <li className="nav-item">
                  <NavLink to={`${match.url}/polls`} className="nav-link">
                ...
                <li className="nav-item">
                  <NavLink to={`${match.url}/create-poll`} className="nav-link">
          ...
          <main role="main" className="col-md-9 ml-sm-auto col-lg-10 px-4">
            <Switch>
              <Route path={`${match.path}/create-poll`}>
                <AddPoll />
              </Route>
              <Route path={`${match.path}/polls/:id`}>
                <Poll />
              </Route>
              <Route path={`${match.path}/polls`}>
                <Polls />
              </Route>
            </Switch>
          </main>
